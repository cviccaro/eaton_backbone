...
public $_page = 0;
        ...
        $margins = array(0,0,0,0))
    {
        ...
        parent::__construct($orientation, $unit, $format, $unicode, $encoding, $diskcache, $margins);
    ...
    //     $this->SetAutoPageBreak(false, 0);
    //     // set bacground image
    //     $img_file = 'http://' . $_SERVER['HTTP_HOST'] . '/' . drupal_get_path('theme','eaton') . '/img/Eaton_Badge_BG.jpg';
